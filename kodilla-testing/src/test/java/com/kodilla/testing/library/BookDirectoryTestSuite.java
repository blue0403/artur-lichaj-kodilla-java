...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNoBooksBorrowed() {
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "88112309813");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf0BorrowedBooks);
    ...
    public void testListBooksInHandsOf1BorrowedBook() {
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "88112309813");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf1BorrowedBooks);
